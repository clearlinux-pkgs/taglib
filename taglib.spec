...
Version  : 2.0.1
Release  : 15
URL      : https://taglib.org/releases/taglib-2.0.1.tar.gz
Source0  : https://taglib.org/releases/taglib-2.0.1.tar.gz
...
%prep
%setup -q -n taglib-2.0.1
cd %{_builddir}/taglib-2.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712783522
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtag.so.2.0.1
/V3/usr/lib64/libtag_c.so.2.0.1
/usr/lib64/libtag.so.2
/usr/lib64/libtag.so.2.0.1
/usr/lib64/libtag_c.so.2
/usr/lib64/libtag_c.so.2.0.1
