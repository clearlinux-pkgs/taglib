...
Source0  : https://taglib.org/releases/taglib-2.0.2.tar.gz
...
%prep
%setup -q -n taglib-2.0.2
cd %{_builddir}/taglib-2.0.2
pushd ..
cp -a taglib-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724683239
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtag.so.2.0.2
/V3/usr/lib64/libtag_c.so.2.0.2
/usr/lib64/libtag.so.2
/usr/lib64/libtag.so.2.0.2
/usr/lib64/libtag_c.so.2
/usr/lib64/libtag_c.so.2.0.2
