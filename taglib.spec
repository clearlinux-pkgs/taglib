...
Source0  : https://taglib.org/releases/taglib-2.0.tar.gz
...
%prep
%setup -q -n taglib-2.0
cd %{_builddir}/taglib-2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706114007
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtag.so.2.0.0
/V3/usr/lib64/libtag_c.so.2.0.0
/usr/lib64/libtag.so.2
/usr/lib64/libtag.so.2.0.0
/usr/lib64/libtag_c.so.2
/usr/lib64/libtag_c.so.2.0.0
